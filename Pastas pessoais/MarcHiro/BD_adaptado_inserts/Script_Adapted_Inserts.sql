...
ALTER TABLE leitura
    ...
    select  E.razaoSocial as Empresa,
			P.idPlantacao as Plantacao,
            P.areaM2 as Area,
            P.tipoSolo as Solo,
			S.lote as Lote,
			S.coordSensor as Posicao,
			S.idSensor as Sensor,
			S.modelo as Modelo,
            L.idLeitura as Leitura,
            L.dataLeitura as 'Data de Captura',
            L.leituraUmidadeSolo as Umidade_do_Solo
            from leitura as L 
            join sensor as S 
